...
public class DemoClass {
	...
	public void PageNavigation() throws IOException {
		 ...
		 * AccountpageObj.password().sendKeys("Hello123!"); if
		 * (AccountpageObj.createaccount().isEnabled()) {
		 * AccountpageObj.createaccount().click(); } else //phone--longInstruction {
		 * System.out.println(driver.findElement(By.id("phone--longInstruction")).
		 * getText());
		 * 
		 * }
		 */
